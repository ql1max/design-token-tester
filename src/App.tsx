...
const TITLE = 'Design Token Tester';
const DESCRIPTION = 'An interactive playground for design system tokens. Adjust color, type, spacing, and radius live, check WCAG contrast, and export the result as CSS variables or JSON.';
const GITHUB_REPO = 'ql1max/design-token-tester';
